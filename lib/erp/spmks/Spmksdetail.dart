...
class Spmksdetail extends StatefulWidget {
  const Spmksdetail({Key key}) : super(key: key);

  @override
  _SpmksdetailState createState() => _SpmksdetailState();
}

class _SpmksdetailState extends State<Spmksdetail> {
  Spmksmodel agrs;

  List<spmksdetailmodel> detail = [];
  String aprovelvl = '0';
  String kdpat = '0';
  @override
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      agrs = ModalRoute.of(context).settings.arguments as Spmksmodel;
      setState(() {
        dxxx(agrs.nOSPMKS == null ? "" : agrs.nOSPMKS);
          ...
          : SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(agrs.nOSPMKS != null ? agrs.nOSPMKS : ""),
                    SizedBox(
                      height: 20,
                    ),
                    Text(agrs.tGLSPMKS != null ? agrs.tGLSPMKS : ""),
                    SizedBox(
                      height: 20,
                    ),
                    Text("Material"),
  ...
  Widget cardku(spmksdetailmodel detail) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, "/spmksitem", arguments: detail);
      },
      child: Card(
          child: Padding(
  ...
  Widget dxxx(String kode) {
    Internethttp().Spmksdetailinternet(kode).then((value) {
      // print(value.length);
      setState(() {
        detail.addAll(value);
      });
