...
class Spmksoverview extends StatefulWidget {
  final String kategoripage;
  const Spmksoverview({Key key, this.kategoripage}) : super(key: key);

  @override
  _BapboverviewState createState() => _BapboverviewState();
}

class _BapboverviewState extends State<Spmksoverview> {
  int page = 0;
  DateTime _selectedDate;
  TextEditingController _textEditingController = TextEditingController();
  ScrollController _controller = ScrollController();
  bool isLoading = false;
  Future<List<Spmksmodel>> x;
  List<Spmksmodel> pagging = [];
  ...
  Widget cardCatalog(Spmksmodel product) {
    return Container(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            product.nOSPMKS != null ? product.nOSPMKS : "",
                          ...
                          Text(
                            product.tGLSPMKS != null ? product.tGLSPMKS : "",
                            style: TextStyle(fontWeight: FontWeight.bold),
                            textAlign: TextAlign.left,
                          ),
                          SizedBox(
                          ...
                          Text(
                            product.nAMAPAT != null ? product.nAMAPAT : "",
                    ...
                    Column(
                      children: [
                        FlatButton(
                            minWidth: 110,
                            onPressed: () {
                              Navigator.pushNamed(context, "/spmksdetail",
                                  arguments: product);
                            },
                            color: Colors.blue,
                            child: Row(
  ...
  Widget d(String ssppdn, String tanggal, String statusinet) {
    Internethttp()
        .spmksinternet(page.toString(), "20", ssppdn, tanggal, statusinet,
